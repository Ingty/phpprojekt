...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    echo '<form action="capsrage.php" method="post">
    ...
    $result = mysqli_query($con,"SELECT * FROM capsrage");
    $rekordy = ceil(mysqli_num_rows($result)/5);
    echo '<form action="capsrage.php method="post">Strona: <select name="strona">';
    for($i=1;$i<=$rekordy;$i++){
    ...
    $uprecord = $strona*5;
    $query = "SELECT * FROM capsrage WHERE id BETWEEN $bottomrecord AND $uprecord ORDER BY data $sort";
