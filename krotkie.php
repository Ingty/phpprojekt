...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    echo '<form action="krotkie.php" method="post">
    ...
    $result = mysqli_query($con,"SELECT * FROM krotkie");
    $rekordy = ceil(mysqli_num_rows($result)/5);
    echo '<form action="krotkie.php method="post">Strona: <select name="strona">';
    for($i=1;$i<=$rekordy;$i++){
    ...
    $uprecord = $strona*5;
    $query = "SELECT * FROM krotkie WHERE id BETWEEN $bottomrecord AND $uprecord ORDER BY data $sort";
